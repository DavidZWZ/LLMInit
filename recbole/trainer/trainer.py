...
class Trainer(AbstractTrainer):
    ...
    def _eval_loss(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        r"""Train the model in an epoch
        ...
        """
        self.model.train()
        loss_func = loss_func or self.model.cal_align
        mf_total_loss = None
        ...
        scaler = amp.GradScaler(enabled=self.enable_scaler)
        mf_total_loss = loss_func()

        return mf_total_loss
