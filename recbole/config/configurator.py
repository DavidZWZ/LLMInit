...
class Config(object):
    ...
    def __init__(
        self, args=None, model=None, dataset=None, config_file_list=None, config_dict=None
    ):
        """
        Args:
    ...
    def _update_parser(self):
        self.final_config_dict["learning_rate"] = float(self.args.lr)
    ...
    def _init_device(self):
        if self.args.gpu:
            self.final_config_dict["gpu_id"] = self.args.gpu 
